...
for i in range(0,30):
    ...
    fobs = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_obs.Asymptotic.mH"+str(m)+".root","READ")
    tobs = fobs.Get("limit")

    f = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_exp.Asymptotic.mH"+str(m)+".root","READ")
    t = f.Get("limit")
    ...
    fobs = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Resolved_untagged_obs.Asymptotic.mH"+str(m)+".root","READ")
    tobs = fobs.Get("limit")

    f = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Resolved_untagged_exp.Asymptotic.mH"+str(m)+".root","READ")
    t = f.Get("limit")
    ...
    fobs = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Resolved_b-tagged_obs.Asymptotic.mH"+str(m)+".root","READ")
    tobs = fobs.Get("limit")

    f = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Resolved_b-tagged_exp.Asymptotic.mH"+str(m)+".root","READ")
    t = f.Get("limit")
    ...
    fobs = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Resolved_vbf-tagged_obs.Asymptotic.mH"+str(m)+".root","READ")
    tobs = fobs.Get("limit")

    f = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Resolved_vbf-tagged_exp.Asymptotic.mH"+str(m)+".root","READ")
    t = f.Get("limit")
...
for i in range(0,26):
    ...
    fobs = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Merged_untagged_obs.Asymptotic.mH"+str(m)+".root","READ")
    tobs = fobs.Get("limit")

    f = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Merged_untagged_exp.Asymptotic.mH"+str(m)+".root","READ")
    t = f.Get("limit")
    ...
    fobs = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Merged_b-tagged_obs.Asymptotic.mH"+str(m)+".root","READ")
    tobs = fobs.Get("limit")

    f = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Merged_b-tagged_exp.Asymptotic.mH"+str(m)+".root","READ")
    t = f.Get("limit")
    ...
    fobs = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Merged_vbf-tagged_obs.Asymptotic.mH"+str(m)+".root","READ")
    tobs = fobs.Get("limit")

    f = TFile("../cards_sm13_1D_12p9fb_fracVBF_0.001_floatFracVBF/HCG/"+str(m)+"/higgsCombinemH"+str(m)+"_Merged_vbf-tagged_exp.Asymptotic.mH"+str(m)+".root","READ")
    t = f.Get("limit")
...
c.SaveAs("highmasslimit_spin0_1D_13TeV_cats.pdf")
c.SaveAs("highmasslimit_spin0_1D_13TeV_cats.png")
