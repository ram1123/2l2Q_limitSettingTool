...
class CombineStrings:
    def __init__(self, date_string = ""):
        ...
        self.Additional = ""
        self.COMBINE_ASYMP_LIMIT = "mH{mH}_{year}"+self.date_string+(self.Additional).upper()+"_{blind}_{bOnlyOrSB}_{Category}"
        self.COMBINE_IMPACT = "mH{mH}_{year}"+self.date_string+(self.Additional).upper()+"_{blind}_{bOnlyOrSB}_{Category}"
