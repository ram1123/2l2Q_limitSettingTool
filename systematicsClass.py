...
class systematicsClass:
    ...
    def setSystematics(self, rates):
        ...
        self.muSelError = 1 + math.sqrt(
            self.sel_muonfull * self.sel_muonfull
            + self.sel_muontrig * self.sel_muontrig
        )
        self.eSelError = 1 + math.sqrt(
            self.sel_elefull * self.sel_elefull + self.sel_eletrig * self.sel_eletrig
        )
