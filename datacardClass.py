...
class datacardClass:
    ...
    def makeCardsWorkspaces(self, theMH, theis2D, theOutputDir, theInputs, theCat, theFracVBF):
        ...
        signalCB_ggH = ROOT.RooCrystalBall(name,name,zz2l2q_mass,rfv_mean_ggH,rfv_sigma_ggH,a1_ggH,n1_ggH,a2_ggH,n2_ggH)
        name = "signalCB_VBF_"+(self.channel)
        signalCB_VBF = ROOT.RooCrystalBall(name,name,zz2l2q_mass,rfv_mean_VBF,rfv_sigma_VBF,a1_VBF,n1_VBF,a2_VBF,n2_VBF)
        ...
        w.importClassCode(RooCrystalBall.Class(),True)
