...
class datacardClass:
    ...
    def makeCardsWorkspaces(self, theMH, theis2D, theOutputDir, theInputs, theCat, theFracVBF):
        ...
        zz2l2q_mass.setRange("fullsignalrange",400,3000)
        ...
        ggHshape = TFile("Resolution/2l2q_resolution_"+self.jetType+".root");
        VBFshape = TFile("Resolution/2l2q_resolution_"+self.jetType+".root");
        ...
        TempFile_fs = TFile("templates1D/Template1D_spin0_"+fs+".root","READ")
        ...
        # shape from 2e+2mu
        TempFile = TFile("templates1D/Template1D_spin0_2l.root","READ")
        ...
        templateSigName = "templates2D/2l2q_spin0_template.root"
        templateSigNameUp = "templates2D/2l2q_spin0_template.root"
        templateSigNameDn = "templates2D/2l2q_spin0_template.root"
        ...
        templatezjetsBkgName = "templates2D/2l2q_spin0_template.root"
        templatezjetsBkgNameUp = "templates2D/2l2q_spin0_template.root"
        templatezjetsBkgNameDn = "templates2D/2l2q_spin0_template.root"
        ...
        ggH_accxeff = ROOT.TFile("SigEff/2l2q_Efficiency_spin0_ggH.root");
        VBF_accxeff = ROOT.TFile("SigEff/2l2q_Efficiency_spin0_VBF.root");
