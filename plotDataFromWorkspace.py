...
input_file = ROOT.TFile.Open("datacards_HIG_23_001/cards_2018_deepjet/HCG/1000/hzz2l2q_mumuqq_Merged_untagged_13TeV.input.root")
workspace = input_file.Get("w")

#print("Workspace: ", workspace.Print())

pdf = workspace.pdf("zjet_mumuqq_Merged_untagged_2018Pdf")
# plot the pdf
vars = workspace.var("zz2lJ_mass")
frame = vars.frame()

pdf.plotOn(frame)
canvas = ROOT.TCanvas("canvas", "canvas")
frame.Draw()
canvas.SaveAs("zjet_mumuqq_Merged_untagged_2018Pdf.png")
